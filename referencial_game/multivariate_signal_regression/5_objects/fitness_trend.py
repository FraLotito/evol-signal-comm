...
plt.plot(gen[::NTH], mean_best_gen[::NTH], color='green', label='Best pair')
...
plt.plot(gen[::NTH], mean_gen[::NTH], color='red', label='Sender pop. avg')
...
plt.plot(gen[::NTH], mean_gen[::NTH], color='blue', label='Receiver pop. avg')
...
plt.xticks(locs[::100]) 
plt.legend(loc=0)
plt.savefig('fitness_trend_multi_reg.pdf', bbox_inches = 'tight')
plt.show()
